...
interface IMyDN404{
    ...
    function initialize(string memory name_, string memory symbol_, uint256 initialTokenSupply, bytes memory _ownerData) external ;
    function setBaseURI(string calldata _baseURI) external ;
    function tokenURI(uint256 id) external view  returns (string memory);
    function setNameSymbol(string calldata _name, string memory _symbol) external;
    function setSkipNFT(bool state) external returns (bool) ;
    function setWhitelist(address to, bool state) external;
    ...
    function _ownerOf(uint256 id) external view  returns (address);
    ...
    function transferFromNFT(address from, address to, uint256 Id) external ;
    ...
    function getVestingPercent() external view returns(uint256);
    ...
    function setVestingPercent(uint256 percent) external;
