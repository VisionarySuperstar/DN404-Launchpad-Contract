...
///   initialization.
abstract contract DN404 is IMyDN404, Initializable{
    /*«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-«-*/
    /*                           EVENTS                           */
    /*-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»-»*/
    ...
    function _getSkipNFT(address owner) internal virtual returns (bool) {
        AddressData storage d = _addressData(owner);
        return (d.flags & _ADDRESS_DATA_SKIP_NFT_FLAG != 0) ;
    }
    ...
    /// Requirements:
    /// - Token `id` must exist.
    function _ownerOf(uint256 id) public view virtual returns (address) {
